        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_.9fr]">
          <form onSubmit={submit} className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
            ...
            <div className="space-y-5">
              ...
              <label className="block"><span className="mb-2 block text-sm font-semibold text-slate-700">Category</span><select name="category" value={form.category} onChange={update} className="w-full rounded-xl border-slate-300"><option value="skincare">Skincare</option><option value="makeup">Modern Color</option><option value="fragrance">Body &amp; Fragrance</option><option value="partnerships">Beauty Partnerships</option></select></label>
