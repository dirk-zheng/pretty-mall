...
import {
  ...
  BriefcaseBusiness, Ruler, Search, ShoppingBag, Tag
} from 'lucide-react';

const categories = [
  { id: 'all', label: 'All buyer resources', icon: BookOpen },
  { id: 'buying', label: 'Assortment Planning', icon: ShoppingBag },
  { id: 'fit', label: 'Fit & Grading', icon: Ruler },
  { id: 'private-label', label: 'Private Label', icon: BriefcaseBusiness },
];
      ...
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
          <div className="max-w-3xl animate-slide-up">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-orange-400/20 bg-orange-400/10 text-orange-200 text-sm mb-6"><BookOpen size={15} />Retail Buyer Resources</div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <section aria-labelledby="latest-insights">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8">
            <div><p className="text-primary font-semibold text-sm uppercase tracking-wider mb-2">Buyer knowledge library</p><h2 id="latest-insights" className="font-heading text-3xl font-bold text-slate-900">Latest retail insights</h2></div>
        ...
        <section className="mt-16 rounded-3xl bg-gradient-to-br from-orange-600 to-amber-500 p-8 md:p-12 text-white flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="max-w-2xl"><div className="flex items-center gap-2 text-orange-100 text-sm font-medium mb-3"><CheckCircle2 size={17} />Preparing a wholesale inquiry?</div><h2 className="font-heading text-3xl font-bold mb-3">Review the questions retail buyers ask most.</h2><p className="text-orange-50/90">MOQ, pricing, samples, size curves, private label, production, QC and U.S. shipping coordination.</p></div>
